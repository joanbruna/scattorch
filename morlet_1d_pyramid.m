...
N = getoptions(options,'length',11);
sigmap0 = getoptions(options,'sigmap0', 0.8);
sigma0 = getoptions(options,'sigma0', 0.8);
sigmap = getoptions(options, 'sigmap',sqrt(2*sigmap0^2-sigma0^2) );
sigma = getoptions(options, 'sigma', sqrt(1.5)*sigma0);
